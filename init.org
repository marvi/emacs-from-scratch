#+title:  marvi's Emacs Configuration 
...
*Important note!*  For =lsp-mode= to work with JavaScript you will need to install a language server on your machine.  If you have Node.js installed, the easiest way to do that is by running the following command:
